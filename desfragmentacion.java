...
public class desfragmentacion extends javax.swing.JFrame{
    ...
    private void initComponents(){
       ...
       // jTextField1 = new javax.swing.JTextField();
        ...
        //jTable1.setToolTipText("Click for combo box");
        jTable2.setToolTipText("Informacion del Proceso.");
    ...
    public Integer Marcos_so() {
        return 0; //Integer.valueOf(jTextField1.getText());
    }
    ...
    public int n_procesos() {
        return 0;//Integer.parseInt(String.valueOf(jSpinner1.getValue()));
    }
